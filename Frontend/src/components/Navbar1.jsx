                ...
                <div className="flex items-center space-x-4">
                  {/* {userRole !== "employer" ? (
                    <>
                      ...
                      <div className="relative">
                        <button
                          ...
                          className="flex items-center space-x-1 p-2 text-gray-600 hover:text-blue-600 hover:bg-gray-50 rounded-md transition-colors"
                        >
                          ...
                          <div className="absolute right-0 top-full mt-2 w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                            ...
                            <div className="border-t border-gray-200 py-2">
                              <button
                                ...
                                className="flex items-center w-full px-4 py-2 text-sm text-blue-600 hover:bg-gray-50 font-medium transition-colors"
                              >
                                Sign out
                              </button>
                            </div>
                    ...
                    <div className="flex items-center space-x-3">
                      <span className="text-sm text-gray-700 max-w-32 truncate">{userEmail}</span>
                      <button
                        onClick={() => {
                          localStorage.removeItem("token");
                          localStorage.removeItem("user");
